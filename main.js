...
document.querySelector("#btn3").onclick = function () {
  ...
  //output
  document.querySelector("#showInfor3").innerHTML =
    "Số nhỏ nhất là: " + listNumber[soMin];
};
...
document.querySelector("#btn4").onclick = function () {
  ...
  //output
  document.querySelector("#showInfor4").innerHTML =
    "Số dương nhỏ nhất: " + listNumber[soDuongMin];
};
...
document.querySelector("#btn5").onclick = function () {
  ...
  //output
  document.querySelector("#showInfor5").innerHTML =
...
document.querySelector("#btn6").onclick = function () {
  ...
  //output
  document.getElementById("showInfor6").innerHTML =
    "Mảng sau khi thay đổi: " + listNumber;
};
...
document.querySelector("#btn9").onclick = function () {
  ...
  //output
  document.querySelector("#showInfor9").innerHTML =
